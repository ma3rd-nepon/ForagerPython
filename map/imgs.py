...
im_i = [pygame.image.load('sprites/player/idle/player_idle1.png'), pygame.image.load('sprites/player/idle/player_idle2.png'),
...
im_h = [pickaxe_1,
        pygame.image.load('sprites/tools/pickaxe_1.png'),
        pygame.image.load('sprites/tools/pickaxe_2.png'),
        pygame.image.load('sprites/tools/pickaxe_4.png')]

...
ALL_KEYS = ['K_BACKSPACE', 'K_TAB', 'K_CLEAR', 'K_RETURN', 'K_PAUSE', 'K_ESCAPE',
            ...
            'K_DELETE', 'K_KP0', 'K_KP1', 'K_KP2', 'K_KP3', 'K_KP4', 'K_KP5', 'K_KP6', 'K_KP7', 'K_KP8', 'K_KP9',
            ...
            'K_F8', 'K_F9', 'K_F10', 'K_F11', 'K_F12', 'K_F13', 'K_F14', 'K_F15',
            'K_NUMLOCK', 'K_CAPSLOCK', 'K_SCROLLOCK', 'K_RSHIFT', 'K_LSHIFT', 'K_RCTRL',

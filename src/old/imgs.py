...
# загрузочный екран
im_title = [pygame.image.load('../../sprites/title/presents_1.png'), pygame.image.load(
    '../../sprites/title/presents_1.png'),
            pygame.image.load('../../sprites/title/presents_1.png'), pygame.image.load(
        '../../sprites/title/presents_2.png'),
            pygame.image.load('../../sprites/title/presents_3.png'), pygame.image.load(
        '../../sprites/title/presents_4.png'),
